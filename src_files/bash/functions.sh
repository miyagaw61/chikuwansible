...
rgc() {
    if [ "$1" = "-h" ] ;then
        echo "Usage: rgc REGEXP COUNT_NUM"
    else
        rg "$1" -C$2 | sed -E "s@^\-\-@___________________________________________________________________________________________________________________________________\n===================================================================================================================================@g"
    fi
}

rga() {
    if [ "$1" = "-h" ] ;then
        echo "Usage: rga REGEXP COUNT_NUM"
    else
        rg "$1" -A$2 | sed -E "s@^\-\-@___________________________________________________________________________________________________________________________________\n===================================================================================================================================@g"
    fi
}
